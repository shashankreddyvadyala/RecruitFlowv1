...
1
frame:pyspark.sql.connect.dataframe.DataFrame = [invoice_id: double, inv_line_number: string ... 5 more fields]
...
OK   c_vendor: 2,610
OK   c_keyword: 34,454
BOOM candidates(all): [CAST_INVALID_INPUT] The value '2003.845C' of the type "STRING" cannot be cast to "DOUBLE" because it is malformed. Correct the value as per the syntax, or change its target type. Use `try_cast` to tolerate malformed input and return NULL instead. SQLSTATE: 22018  JVM stacktrace: org.apache.spark.Sp
